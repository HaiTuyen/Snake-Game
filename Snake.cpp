...
void Snake_Drawing(Snake& snake)
{
	char dum = 205;
...
void Snake_Initialize(Snake& snake)
{
	...
	if (snake.seg)
	{
		snake.seg[0].symbol = '2';
		snake.seg[1].symbol = '1';
...
void Segment_Update(Snake& snake)
{
	int x, y;
...
void Snake_Moving(Snake& snake, int foodx, int foody, ListName listname[])
{
	//initialize key
	static char key = 'a';
	static char lock = 'd';
...
void Segment_Insert(Snake& snake)
{
	snake.size++;
